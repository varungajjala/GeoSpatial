...
public class App
{
    public static void main( String[] args )
    {
        ...
        //JavaRDD<String> input = sparkcontext_obj.textFile("hdfs://master:54310/team17/operation2/ConvexHullTestData.csv");
        //JavaRDD<String> input = sparkcontext_obj.textFile("hdfs://master:54310/team17/arealm.csv");
        JavaRDD<String> input = sparkcontext_obj.textFile("hdfs://master:54310/team17/areawater.csv");
		...
		final_output.repartition(1).saveAsTextFile("hdfs://master:54310/team17/operation2/output_convex_hull_ld.txt");
	}
}
